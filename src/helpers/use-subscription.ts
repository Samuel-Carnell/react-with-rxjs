 ...
 *
 * @typeParam TSubscription The type of value produced by `subscriptionFactory`.
 * @param subscriptionFactory Function to use to re/compute the returned subscription.
 * @param dependencies A list of dependencies used by `subscriptionFactory` function.
 * @internal
 */
